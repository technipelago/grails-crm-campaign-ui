...
<head>
    ...
    <title><g:message code="crmCampaignStatus.create.title" args="[entityName]"/></title>
</head>

<body>

<crm:header title="crmCampaignStatus.create.title" args="[entityName]"/>
    ...
    <div class="span9">
        ...
        <g:form class="form-horizontal" action="create">
            ...
            <div class="form-actions">
                <crm:button visual="primary" icon="icon-ok icon-white" label="crmCampaignStatus.button.save.label"/>
